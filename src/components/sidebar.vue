...
<template>
    <pv-Sidebar style="background: #F6F8FF;" v-model:visible="visible">
        ...
        <div class="flex flex-column h-full">
          <div class="flex align-items-center justify-content-between px-4 pt-3 flex-shrink-0">
                  <span class="inline-flex align-items-center gap-3">
                      ...
                      <span class="font-semibold text-2xl text-primary">MEAL MASTER</span>
                  </span>
            <span>
                ...
                <ul class="list-none p-0 m-0 overflow-hidden">
                  ...
                  <li>
                    <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                      ...
                      <span class="font-medium">Plan de hoy</span>
                    </a>
                  </li>
                  <li>
                    <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
                      <i class="pi pi-calculator mr-2"></i>
                      <span class="font-medium">Calculadora de calorias</span>
                    </a>
                  </li>
                  <li>
                    <a v-ripple class="flex align-items-center cursor-pointer p-3 border-round text-700 hover:surface-100 transition-duration-150 transition-colors p-ripple">
    ...
    <pv-Button class="custom-Button" icon="pi pi-bars" @click="visible = true" />
</template>
