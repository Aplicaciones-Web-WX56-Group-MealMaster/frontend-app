<script>
import barralateral from "./sidebar.vue";
export default {
  name: "navbar",
  components:{
    barralateral
...
/* Estilo para el texto dentro del pv-Toolbar */
.custom-toolbar h1 {
...
/* Estilo para los botones dentro del pv-Toolbar */
.custom-toolbar pv-Button,
.custom-toolbar pv-Avatar {
